...
set exec_info="%JAVA_HOME%\bin\java" -server -Xmx512m -Xms512m -XX:MaxNewSize=64m -XX:NewSize=64m -XX:+UseConcMarkSweepGC -classpath %CLASSPATH%; com.pipe.virtual.peer.VirtualPeer  %*
echo %exec_info%
%exec_info%

 ...
 * under the License.
 */
package com.pipe.common.net.ssl;
 ...
 * created by this factory sends a bogus certificate defined in {@link PipeKeyStore}.
 * <p>
 ...
 * </ul>
 */
public final class PipeSslContextFactory {
    ...
    static {
        ...
        try {
            ...
            ks.load(PipeKeyStore.asInputStream(),
                    PipeKeyStore.getKeyStorePassword());

            // Set up key manager factory to use our key store
            KeyManagerFactory kmf = KeyManagerFactory.getInstance(algorithm);
            kmf.init(ks, PipeKeyStore.getCertificatePassword());
        ...
        try {
            ...
            clientContext.init(null, PipeTrustManagerFactory.getTrustManagers(), null);
        } catch (Exception e) {
            throw new Error(
